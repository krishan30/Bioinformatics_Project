...
dataset1_sequences = filter_critical_sequences(load_sequences_from_csv("Dataset/dataset_2.csv"))
...
dataset_parts[0].to_csv("Dataset/dataset_2_data_sub_part_1.csv", index=False)
dataset_parts[1].to_csv("Dataset/dataset_2_data_sub_part_2.csv", index=False)
dataset_parts[2].to_csv("Dataset/dataset_2_data_sub_part_3.csv", index=False)
dataset_parts[3].to_csv("Dataset/dataset_2_data_sub_part_4.csv", index=False)
dataset_parts[4].to_csv("Dataset/dataset_2_data_sub_part_5.csv", index=False)